                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label style="color: #326949;">Foto</label> <!-- Apply color to label -->
                                        {{-- view image --}}
                                        @if ($edit->foto)
                                ...
                                <div class="col-md-8">
                                    <div class="form-group">
                                        <label style="color: #326949;">Hak Akses</label> <!-- Apply color to label -->
                                    ...
                                    <div class="form-group">
                                        <label style="color: #326949;">Status</label> <!-- Apply color to label -->
                                    ...
                                    <div class="form-group">
                                        <label style="color: #326949;">Nama</label> <!-- Apply color to label -->
                                ...
                                @error('nama') is-invalid @enderror"
                                    ...
                                    <div class="form-group">
                                        <label style="color: #326949;">Email</label> <!-- Apply color to label -->
                                ...
                                @error('email') is-invalid @enderror"
                                    ...
                                    <div class="form-group">
                                        <label style="color: #326949;">HP</label> <!-- Apply color to label -->
                        ...
                        <div class="border-top">
                            <div class="card-body">
                                <button type="submit" class="btn"
                                    style="background-color: #326949; border-color: #326949; color: white;">Perbaharui</button>
